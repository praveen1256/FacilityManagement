import { StyleProp, View, ViewStyle, Linking, Platform, ActivityIndicator, Animated } from "react-native";
...
import { FullWorkTask, ServiceRequest, ServiceRequestResource } from "../../../store/WorkTask/reducer";
...
const GeneralCard: React.FC<GeneralCardProps> = ({
    ...
    const startAnimating = (duration = 600) => {
        fadeAnim.setValue(0);
                ...
                >
                    <Badge
                        style={{
                            ...
                            backgroundColor: workTask.TaskPriority.value === "P1" ? theme.colors?.p1 : theme.colors?.p2,
                            fontWeight: "bold",
                            alignSelf: "center",
                            marginBottom: 2,
                        }}
                ...
                >
                    ...
                    <Card.Content>
                        ...
                        <View>
                            ...
                            {serviceRequestError && <Text variant="bodySmall">{serviceRequestError}</Text>}
                        </View>
                        {/* <View>
